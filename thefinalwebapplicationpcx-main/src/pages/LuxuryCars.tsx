...
// Advanced Booking Modal Component
...
- Payment Method: ${formData.paymentMethod === 'card' ? 'Credit Card' : formData.paymentMethod === 'crypto' ? 'Cryptocurrency' : formData.paymentMethod === 'cash' ? 'Cash (Swiss Location)' : 'Bank Transfer'}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        {/* Cash payment option for Swiss cities */}
                        {car.location && (() => {
                          const location = car.location.toLowerCase();
                          const swissCities = ['switzerland', 'zurich', 'geneva', 'basel', 'bern', 'lausanne', 'lugano', 'winterthur', 'lucerne', 'st. gallen', 'thun', 'köniz', 'la chaux-de-fonds', 'fribourg', 'schaffhausen', 'chur', 'neuchâtel', 'uster', 'sion', 'emmen'];
                          return swissCities.some(city => location.includes(city));
                        })() && (
                          <label className="cursor-pointer">
                            <input
                              type="radio"
                            ...
                            <div className={`border-2 rounded-xl p-3 transition-all ${
                              ...
                              <div className="text-xs text-gray-500 mt-1 text-center">Swiss locations</div>
                            </div>
                          </label>
                        )}
                      </div>
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 pt-[88px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {/* HERO - Updated with thin font weight */}
