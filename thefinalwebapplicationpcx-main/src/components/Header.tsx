  ...
  <div className="p-6">
    <div className="grid grid-cols-2 gap-12">
      ...
      <div className="space-y-6">
        ...
        <a href="/web3/tokenization" className="flex items-start gap-4 group cursor-pointer">
          <div className="p-3 bg-gray-100 rounded-lg group-hover:bg-gray-200 transition-colors">
...
// UserMenu component (using your actual import)
const UserMenuComponent = ({ onLogout, onShowDashboard }) => (
  <div className="user-menu">
    <UserMenu onLogout={onLogout} onShowDashboard={onShowDashboard} />
  </div>
);

// WalletMenu component (using your actual import)
const WalletMenuComponent = ({ onConnect }) => (
  <WalletMenu onConnect={onConnect} />
);

// Mock hooks (replace with your actual ones)
