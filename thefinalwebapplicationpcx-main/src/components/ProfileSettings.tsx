  ...
  return (
    <div className="p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-medium text-gray-900 mb-1">Profile Settings</h1>
        ...
        {!isEditing ? (
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 text-gray-600 hover:text-black border border-gray-200 rounded-lg hover:border-gray-300 transition-colors"
            >
              Cancel
            </button>
            <button
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="text-gray-900 font-medium">{user?.first_name || 'Not set'}</div>
              </div>
              <div>
                <div className="text-sm text-gray-500 mb-1">Last Name</div>
                <div className="text-gray-900 font-medium">{user?.last_name || 'Not set'}</div>
              </div>
              <div>
