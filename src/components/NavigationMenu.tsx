...
export default function NavigationMenu() {
  ...
  const daoGovernanceItems = [
    { label: "Create DAO", href: "/dao/create-dao" },
    { label: "DAO Projects", href: "/dao/dao-projects" }
  ];
        ...
        >
          <div className="flex">
            ...
            <div className="w-72 p-8 bg-gray-50/50">
              ...
              <div className="mt-8">
                <h3 className="text-sm font-semibold text-gray-900 mb-5">DAO-Governance</h3>
                <div className="space-y-3">
                  {daoGovernanceItems.map((item, index) => (
                    <button
                      key={index}
                      onClick={() => handleNavigation(item.href)}
                      className="block w-full text-left text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200"
