...
const LuxuryCarDetail = () => {
  ...
  const fetchCar = async () => {
    ...
    try {
      ...
      setTimeout(() => navigate('/dashboard?tab=luxury-cars'), 2000);
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <nav className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-5">
          <div className="flex items-center space-x-6 overflow-x-auto scrollbar-hide">
            <button onClick={() => navigate('/dashboard?tab=luxury-cars')} className="py-4 text-sm text-gray-600 hover:text-black whitespace-nowrap">
              ← Back to Marketplace
            </button>
