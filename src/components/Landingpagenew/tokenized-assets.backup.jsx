...
import Dashboard from '../../../thefinalwebapplicationpcx-main/src/components/Dashboard';
          ...
          <div className="p-6">
            ...
            <nav className="border-b border-gray-200 mb-6">
              <div className="flex space-x-6 overflow-x-auto">
                ...
                <button
                  onClick={() => { setActiveCategory('dashboard'); setCurrentPage(1); }}
                  className={`py-4 text-sm whitespace-nowrap border-b-2 transition-colors ${activeCategory === 'dashboard' ? 'text-black border-black' : 'text-gray-600 border-transparent hover:text-gray-900'}`}
                >
                  ● Dashboard
                </button>
              </div>
            ...
            {activeCategory === 'dashboard' && (
              <div className="w-full -mt-6">
                <div className="dashboard-wrapper">
                  <style>{`
                    /* Modern Dashboard Styling with Sidebar */
                    .dashboard-wrapper {
                      font-family: 'DM Sans', sans-serif !important;
                    }

                    /* Keep sidebar visible and style it */
                    ...
                    /* Hide top header only */
                    .dashboard-wrapper header {
                      display: none !important;
                    }

                    /* Style sidebar buttons */
                    .dashboard-wrapper aside button,
                    .dashboard-wrapper aside a {
                      font-family: 'DM Sans', sans-serif !important;
                    ...
                    .dashboard-wrapper aside button:hover,
                    .dashboard-wrapper aside a:hover {
                      background: #f9fafb !important;
                      color: #111827 !important;
                    }

                    .dashboard-wrapper aside button.active,
                    .dashboard-wrapper aside a.active {
                    ...
                    .dashboard-wrapper .bg-gray-900,
                    .dashboard-wrapper .bg-gray-800 {
                      background-color: white !important;
                      color: #111827 !important;
                    }

                    .dashboard-wrapper .text-white {
                      color: #111827 !important;
                    }

                    .dashboard-wrapper .bg-gray-50 {
                      background-color: #f9fafb !important;
                    }

                    /* Card styling */
                    .dashboard-wrapper .rounded-2xl,
                    .dashboard-wrapper .rounded-xl,
                    .dashboard-wrapper .rounded-lg {
                    ...
                    /* Compact padding */
                    .dashboard-wrapper .p-6 {
                      padding: 1.25rem !important;
                    }
                    .dashboard-wrapper .p-8 {
                      padding: 1.5rem !important;
                    }
                    ...
                    /* Borders */
                    .dashboard-wrapper .border-gray-700,
                    .dashboard-wrapper .border-gray-800 {
