/*
  ...
  1. Security Updates
    - Drop existing problematic policies for invoices table
    - Create new, more permissive policies that allow proper invoice creation
    - Fix any type mismatches or permission issues

  2. Changes
    - Allow any authenticated user to create invoices
    - Ensure proper access control for viewing and managing invoices
    - Fix the RLS violation error when creating new invoices
*/
