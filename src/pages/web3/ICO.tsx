...
import TokenSwap from '../../components/Landingpagenew/TokenSwap';
...
export default function ICO() {
  ...
  const handleBuyOnUniswap = () => {
    window.location.href = 'mailto:info@privatecharterx.com?subject=PVCX Token Purchase Inquiry';
  };
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-[120px]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {/* Token Economics */}
          <div className="bg-white py-16 rounded-xl border border-gray-100 mb-16">
          ...
          <div className="mb-16">
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
              <div className="flex justify-center py-8">
                <video
                  className="w-64 h-64 object-cover rounded-2xl transform hover:scale-105 transition-all duration-500"
              ...
              <div className="p-8 text-center">
                ...
                <button
                  onClick={() => window.open('https://opensea.io/collection/privatecharterx-membership-card', '_blank')}
            ...
            <div className="max-w-4xl mx-auto px-8 text-center">
              ...
              <div className="bg-gray-100 p-8 rounded-2xl">
                <div className="flex items-center justify-center gap-4 mb-4">
                  ...
                  <span className="text-lg font-medium text-gray-700">Coming Q2 2026</span>
                  <div className="w-3 h-3 bg-gray-400 rounded-full animate-pulse"></div>
                </div>
