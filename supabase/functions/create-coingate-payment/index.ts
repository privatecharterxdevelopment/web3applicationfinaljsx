...
serve(async (req) => {
  ...
  try {
    ...
    const { serviceType, serviceId, userId, walletAddress, email, contactName, contactPhone, passengers, specialRequests } = paymentData;
    ...
    // Create booking record in user_bookings
