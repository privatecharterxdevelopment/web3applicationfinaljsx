/*
  # Create fixed offers table and sample data

  1. New Tables
    - `fixed_offers` - Stores fixed offers and empty leg flights
      - `id` (uuid, primary key)
      - `title` (text)
      - `description` (text)
      - `origin` (text)
...
VALUES 
  (
    ...
    'Experience the ultimate luxury weekend getaway to the City of Light. This exclusive package includes round-trip private jet transportation, VIP terminal access, and premium onboard catering.
...
With a flight time of just 1 hour and 15 minutes, you''ll arrive in Paris refreshed and ready to explore. Our concierge team can arrange luxury accommodations, restaurant reservations, and exclusive experiences to make your Paris weekend truly unforgettable.',
  ...
  (
    ...
    'Escape to the pristine slopes of the Swiss Alps with our exclusive ski adventure package. This all-inclusive journey takes you from the heart of London directly to Sion, Switzerland, just minutes from world-class ski resorts.
...
Upon arrival, our ground team will transfer you directly to your chosen resort, with options including Verbier, Zermatt, or Gstaad. This package can be customized to include luxury accommodation and lift passes upon request.',
  ...
  (
    ...
    'Connect seamlessly to your Mediterranean yacht charter with our bespoke private jet service. This exclusive package flies you directly from London to Nice, where our team will arrange helicopter transfer to Monaco or your yacht''s specific location.
...
This service is designed for discerning travelers who value time and comfort, eliminating the hassles of commercial travel and ensuring you arrive at your yacht refreshed and ready to begin your maritime adventure.',
  ...
  (
    ...
    'Experience the ultimate Caribbean adventure with our exclusive island-hopping package. This bespoke journey allows you to explore multiple Caribbean destinations in style and comfort.
