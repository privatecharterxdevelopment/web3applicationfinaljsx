...
CREATE TABLE IF NOT EXISTS calendar_events (
    ...
    chat_request_id UUID, -- Link to chat request (no foreign key constraint)
...
COMMENT ON COLUMN calendar_events.chat_request_id IS 'Links event to AI chat request (no foreign key - optional)';
