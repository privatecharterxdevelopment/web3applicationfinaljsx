...
export default function RegisterModal({ isOpen, onClose, onSwitchToLogin }: RegisterModalProps) {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      console.error('[Auth] Google registration error:', err);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-lg max-w-md w-full border-2 border-gray-200 animate-fade-in max-h-[90vh] overflow-y-auto">
        {/* Header */}
